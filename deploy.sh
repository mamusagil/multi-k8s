docker build -t stephengrider/multi-client:latest -t tephengrider/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t stephengrider/multi-server:latest -t tephengrider/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t stephengrider/multi-worker:latest -t tephengrider/multi-worker:$SHA -f ./worker/Dockerfile ./worker
